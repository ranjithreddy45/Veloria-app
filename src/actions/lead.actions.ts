...
// ============================================================
// Filter/scope semantics live in ONE place, shared with the CSV export — see
// lib/crm/lead-filters. The export used to be unable to reach this logic, which
// is why it ignored filters entirely.
export type { LeadListFilters, LeadScope } from "@/lib/crm/lead-filters";
