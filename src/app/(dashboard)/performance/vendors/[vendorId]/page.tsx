...
import { getVendorPerformanceDetail } from "@/actions/performance-score.actions";
...
// ============================================================
// Vendor Performance Detail Page
// ============================================================

interface VendorPerformanceDetailPageProps {
  params: Promise<{ vendorId: string }>;
}

export default async function VendorPerformanceDetailPage({
  params,
}: VendorPerformanceDetailPageProps) {
  const { vendorId } = await params;
  const result = await getVendorPerformanceDetail(vendorId);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={
          latestScore
            ? `Vendor performance for period ${latestScore.period}`
            : "Vendor performance detail"
        }
      >
        <Button variant="outline" asChild>
          <Link href="/performance/vendors">
