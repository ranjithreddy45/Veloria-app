...
// ============================================================
// Employee-wise BD metric bar chart — pick a metric, compare execs.
...
export interface BdEmployeeRow {
  userId: string;
  name: string;
  leadsCold: number;
...
const METRICS: { key: keyof BdEmployeeRow; label: string; color: string }[] = [
...
export function BdEmployeeChart({ employees }: { employees: BdEmployeeRow[] }) {
  const [metricKey, setMetricKey] = useState<keyof BdEmployeeRow>("leadsTotal");
