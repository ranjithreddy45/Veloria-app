              ...
              {rows.map((r) => (
                <TableRow key={r.employee.id}>
                  <TableCell className="font-medium">
                    ...
                    <span className="ml-1.5 text-[11.5px] text-muted-foreground">{r.employee.empCode}</span>
                  </TableCell>
                  <TableCell className="text-[13px] text-muted-foreground">{r.employee.department?.name ?? "—"}</TableCell>
