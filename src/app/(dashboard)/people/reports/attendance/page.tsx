        ...
        {REPORTS.map((r) => {
          ...
          return (
            <Link
              key={r.href}
              href={r.href}
              className="group relative flex flex-col gap-3 surface-glass rounded-[22px] p-5 transition-[transform,box-shadow] duration-300 ease-[cubic-bezier(0.34,1.4,0.64,1)] hover:-translate-y-1 hover:shadow-card-hover"
            >
