  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mx-auto max-w-lg rounded-2xl border border-dashed bg-card p-8 text-center shadow-card sm:p-10">
        ...
        <h3 className="font-editorial mt-5 text-[22px] leading-tight">Coming soon</h3>
        ...
        <ul className="mx-auto mt-5 max-w-sm space-y-1.5 text-left text-[13px] text-muted-foreground">
          {bullets.map((b) => (
