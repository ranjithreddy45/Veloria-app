      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l dark:[border-right-color:oklch(1_0.01_277_/_8%)]",
          className
        )}
        {...props}
      >
        <div
          ...
          className="bg-sidebar flex h-full w-full flex-col group-data-[variant=floating]:surface-glass group-data-[variant=floating]:rounded-[26px] group-data-[variant=floating]:overflow-hidden"
        >
          {children}
        </div>
      </div>
