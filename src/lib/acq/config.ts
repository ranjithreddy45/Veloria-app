...
export const PROJECTION_CONFIG_DEFAULTS: Record<string, string> = {
  ...
  PROJ_EVENTS_MAX_YEAR3: String(PROJECTION_CONST.EVENTS_MAX_YEAR3),
  PROJ_EVENTS_MAX_YEAR3_BEST: String(PROJECTION_CONST.EVENTS_MAX_YEAR3_BEST),
...
export async function getProjectionConfig(): Promise<ResolvedProjectionConfig> {
  ...
  const config: ProjectionConfig = {
    EVENTS_RAMP: ramp,
    EVENTS_MAX_YEAR3: numOr("PROJ_EVENTS_MAX_YEAR3", PROJECTION_CONST.EVENTS_MAX_YEAR3),
    EVENTS_MAX_YEAR3_BEST: numOr("PROJ_EVENTS_MAX_YEAR3_BEST", PROJECTION_CONST.EVENTS_MAX_YEAR3_BEST),
