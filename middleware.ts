...
export const config = {
  matcher: [
     ...
     */
    "/((?!api/auth|api/widget|api/track|api/webforms|api/webhooks|api/ota|form|_next/static|_next/image|favicon.ico|sitemap.xml|robots.txt|\\.well-known|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.gif$|.*\\.svg$|.*\\.ico$|.*\\.webp$).*)",
  ],
};
